...
def get_params():
    ...
    parser.add_argument(
        ...
        type=str,
        default="experiments",
        help="Experiment saved root path",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="reload path for pre-trained model / ner model",
    )
    parser.add_argument(
        "--seed", type=int, default=555, help="random seed (three seeds: 555, 666, 777)"
    )
    ...
    parser.add_argument(
        "--num_tag", type=int, default=0, help="Number of entity in the dataset"
    )
    ...
    # use SPLIT
    parser.add_argument(
        "--newbert", default=False, action="store_true", help="use split"
    )
    parser.add_argument(
        "--span_num_labels", type=int, default=3, help="Number of entity in the dataset"
    )

    # use BiLSTM
    parser.add_argument(
        "--bilstm", default=False, action="store_true", help="use bilstm-crf structure"
    )
    parser.add_argument("--emb_dim", type=int, default=300, help="embedding dimension")
    parser.add_argument(
        "--n_layer", type=int, default=2, help="number of layers for LSTM"
    )
    parser.add_argument(
        "--emb_file",
        type=str,
    ...
    parser.add_argument(
        "--lstm_hidden_dim", type=int, default=256, help="embedding dimension"
    )
    parser.add_argument(
        "--usechar", default=False, action="store_true", help="use character embeddings"
    )
    parser.add_argument("--coach", default=False, action="store_true", help="use coach")
    parser.add_argument(
        "--entity_enc_hidden_dim",
        type=int,
        default=300,
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help="use conll2003 ner dataset for pre-training",
    )
    parser.add_argument(
        "--joint",
        default=False,
        action="store_true",
        help="joint train conll2003 data with target domain data",
    )
